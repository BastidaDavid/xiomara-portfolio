...
export const seedProjects: Project[] = [
  project(1, "Sea Guardian", "sea-guardian.jpg", "illustration", "Collage digital con texturas textiles, composición narrativa y color aplicado por capas.", ["#57b8c8", "#e6d4b1", "#c94f64", "#214f58"], 0.69),
  project(2, "Mushroom House", "mushroom-house.jpg", "concepts", "Ilustración digital con linea limpia, sombreado suave y construccion de ambiente fantastico.", ["#ed3328", "#16a5a9", "#f0d1a4", "#1d3436"], 1),
  project(3, "Floral Character", "floral-character.jpg", "characters", "Collage digital de personaje con texturas organicas, recortes y paleta natural.", ["#d99d25", "#2f7246", "#a72027", "#b8d4e6"], 0.69),
  ...
  project(7, "Tea Boom Brand", "tea-boom-brand.jpg", "branding", "Sistema visual de marca con empaque, patrones, color comercial y composición promocional.", ["#f28424", "#ec3f74", "#f0c83f", "#293c2f"], 1.88, true),
  ...
  project(21, "Royal Bunny", "royal-bunny-character.jpg", "characters", "Diseño digital de personaje con mascota, corona, vestuario y estilo cartoon.", ["#c78b2f", "#f1d6aa", "#5a5c62", "#d4a04a"], 1, true),
  ...
  project(25, "Visual Exploration", "mexico-2045.jpg", "digital", "Composicion digital conceptual con fotomontaje, tipografia y direccion visual futurista.", ["#6fa7c9", "#d8c28a", "#d2609c", "#273342"], 0.69, true),
